...
- Planner retry on failed validation: not detected
...
- Runtime scripts: `scripts/build_template_backgrounds.py`, `scripts/extract_input_text.py`, `scripts/generate-layout-corpus.js`, `scripts/pdf_image_extractor.py`, `scripts/qa_rendered_deck.py`, `scripts/test-validator.js`
